package springCore.SpringCore.valueInjection;
...
//		System.out.println(car.mileadge());
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("springCore/SpringCore/valueInjection/vehicleConfig.xml");
